 ...
 */
public class FavFilm extends Fragment  implements LoadCallback, Adapter.OnItemClickListener {
    Adapter adapter;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_favfilm, container, false);
        mProgressBar = v.findViewById(R.id.loading_film);
        RecyclerView mRecyclerView = v.findViewById(R.id.rvfilm);
        ...
        adapter.setOnItemClickListener(FavFilm.this);
